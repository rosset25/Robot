...
if __name__=="__main__":
	try:
		...
		while True:
			...
			#si se encuentra un obstáculo retrocede girando
			if robot.ultrasound() < 42:
				robot.motors(-50/2,-45)
				time.sleep(0.5)
				
				#gira al lado contrario para esquivarlo
				while robot.ultrasound() < 55: 
					robot.motors(50,0)
					time.sleep(0.1)			
